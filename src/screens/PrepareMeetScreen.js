...
import { ChevronLeft, EllipsisVertical, Info, Link, Mic, MicOff, MonitorUp, Share, Shield, Video, VideoOff } from 'lucide-react-native';
...
const PrepareMeetScreen = () => {
  ...
  const renderParticipantText = () => {
    ...
    const count = participants.length > 2 ? ` ans ${participants.length - 2} others` : "";
    ...
    <View style={prepareStyles.container}>
      ...
      <ScrollView contentContainerStyle={{flex: 1}}>
          <View style={prepareStyles.videoContainer}>
            ...
            {/* Share screen button UI for future upgrade screen share functionality */}
            ...
            <View style={prepareStyles.infoContainer}>
              ...
              <View style={[{marginLeft: 38}]}>
                {/* <Link size={RFValue(14)} color={Colors.text} /> */}
                <Text style={prepareStyles.linkHeader}>Meeting Link</Text>
                <Text style={prepareStyles.linkText}>meeting.google.com/{addHyphens(sessionId)}</Text>
              </View>
